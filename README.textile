...
<pre>sudo gem install git://github.com/GavinM/factory_grabber.git</pre>

h4. As a plugin:

<pre>script/plugin install git://github.com/GavinM/factory_grabber.git</pre>
...
Grab.one_admin_user # => will not find records from the database.
	</code>
</pre>
h2. Feedback
